...
export class LoveUtils {
  ...
  static getZodiacSign(dobStr: string): ZodiacInfo {
    ...
    switch (month) {
      case 1:
        return day < 20
          ? { nameVi: 'Ma Kết', nameEn: 'Capricorn', emoji: '♑', dateRange: '22/12 - 19/01' }
          : { nameVi: 'Bảo Bình', nameEn: 'Aquarius', emoji: '♒', dateRange: '20/01 - 18/02' };
      case 2:
        return day < 19
          ? { nameVi: 'Bảo Bình', nameEn: 'Aquarius', emoji: '♒', dateRange: '20/01 - 18/02' }
          : { nameVi: 'Song Ngư', nameEn: 'Pisces', emoji: '♓', dateRange: '19/02 - 20/03' };
      case 3:
        return day < 21
          ? { nameVi: 'Song Ngư', nameEn: 'Pisces', emoji: '♓', dateRange: '19/02 - 20/03' }
          : { nameVi: 'Bạch Dương', nameEn: 'Aries', emoji: '♈', dateRange: '21/03 - 19/04' };
      case 4:
        return day < 20
          ? { nameVi: 'Bạch Dương', nameEn: 'Aries', emoji: '♈', dateRange: '21/03 - 19/04' }
          : { nameVi: 'Kim Ngưu', nameEn: 'Taurus', emoji: '♉', dateRange: '20/04 - 20/05' };
      case 5:
        return day < 21
          ? { nameVi: 'Kim Ngưu', nameEn: 'Taurus', emoji: '♉', dateRange: '20/04 - 20/05' }
          : { nameVi: 'Song Tử', nameEn: 'Gemini', emoji: '♊', dateRange: '21/05 - 20/06' };
      case 6:
        return day < 21
          ? { nameVi: 'Song Tử', nameEn: 'Gemini', emoji: '♊', dateRange: '21/05 - 20/06' }
          : { nameVi: 'Cự Giải', nameEn: 'Cancer', emoji: '♋', dateRange: '21/06 - 22/07' };
      case 7:
        return day < 23
          ? { nameVi: 'Cự Giải', nameEn: 'Cancer', emoji: '♋', dateRange: '21/06 - 22/07' }
          : { nameVi: 'Sư Tử', nameEn: 'Leo', emoji: '♌', dateRange: '23/07 - 22/08' };
      case 8:
        return day < 23
          ? { nameVi: 'Sư Tử', nameEn: 'Leo', emoji: '♌', dateRange: '23/07 - 22/08' }
          : { nameVi: 'Xử Nữ', nameEn: 'Virgo', emoji: '♍', dateRange: '23/08 - 22/09' };
      case 9:
        return day < 23
          ? { nameVi: 'Xử Nữ', nameEn: 'Virgo', emoji: '♍', dateRange: '23/08 - 22/09' }
          : { nameVi: 'Thiên Bình', nameEn: 'Libra', emoji: '♎', dateRange: '23/09 - 22/10' };
      case 10:
        return day < 23
          ? { nameVi: 'Thiên Bình', nameEn: 'Libra', emoji: '♎', dateRange: '23/09 - 22/10' }
          : { nameVi: 'Bọ Cạp', nameEn: 'Scorpio', emoji: '♏', dateRange: '23/10 - 21/11' };
      case 11:
        return day < 22
          ? { nameVi: 'Bọ Cạp', nameEn: 'Scorpio', emoji: '♏', dateRange: '23/10 - 21/11' }
          : { nameVi: 'Nhân Mã', nameEn: 'Sagittarius', emoji: '♐', dateRange: '22/11 - 21/12' };
      case 12:
        return day < 22
          ? { nameVi: 'Nhân Mã', nameEn: 'Sagittarius', emoji: '♐', dateRange: '22/11 - 21/12' }
          : { nameVi: 'Ma Kết', nameEn: 'Capricorn', emoji: '♑', dateRange: '22/12 - 19/01' };
      default:
        return { nameVi: 'Không rõ', nameEn: 'Unknown', emoji: '❓', dateRange: '' };
    }
  }
  ...
  static generateSystemMilestones(anniversaryDateStr: string): MilestoneItem[] {
    ...
    // Mốc ngày: 100, 200, 300, ..., 11000 (~30 năm)
    for (let days = 100; days <= 11000; days += 100) {
